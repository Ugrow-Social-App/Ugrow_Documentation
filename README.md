# 🗂️ Ugrow's Documentation - Documentação do Ugrow
- Ugrow's Documentation (EN)
...
- #### Visão Geral do Projeto ([project-overview](./public/docs/project-overview/)):
    Contém os documentos relacionados a submissão do projeto ao programa de bolsas de extensão universitária PIBEX e o contexto geral do projeto. Os documentos asseguir:

    - **<span id="document-1" >Visão Geral do Projeto</span> ([project-context.md](./public/docs/project-overview/project-context.md)):** este documento é uma síntese do projeto acadêmico, informando resumidamente o seu contexto, objetivo, público-alvo e justificativa social e acadêmica.
...
- #### Requerimentos e Arquitetura ([architecture-and-requirements](./public/docs/architecture-and-requirements/))
    ...
    - **<span id="document-8">Características da Arquitetura</span> ([architectural-characteristics.md](./public/docs/architecture-and-requirements/architectural-characteristics.md)):** este documento apresenta todas as características da arquitetura escolhidas para essa aplicação.

    - **<span id="document-9">Restrições e Premissas Arquiteturais</span> ([constraints-and-assumptions](./public/docs/architecture-and-requirements/constraints-and-assumptions.md)):** este documento apresenta as restrições e premissas arquiteturais definidas para orientar nas decisões da arquitetura antes do ínicio ou durante as próximas fases do projeto.
...
- #### Manual do Usuário
    ...
    - **<span id="documento-13">Manual do Usuário</span> ([user-manual](./public/docs/user-manual/user-manual.md)):** esse documento é uma base para os manuais em .pdf em inglês e português do Brasil.

- #### Documentação do Projeto ([project-documentation](./public/docs/project-documentation/))
    Contém a documentação final do projeto.

    - **<span>Documentação final do projeto</span> ([ugrow-final-documentation](./public/docs/project-documentation/ugrow-final-documentation.md)):** esse documento tem o objetivo descrever a documentação do final do projeto, reunindo as etapas de construção do projeto até os resultados chegados com a implemntação da aplicação.